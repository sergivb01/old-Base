...
public class Security {
    ...
    private String securityKey = "Gigyig7h78hh9h5hu89745gfuUYGUUrfGJKG";
    private boolean debug = false;

    public Security(String licenseKey, String validationServer, Plugin plugin){
        this.licenseKey = licenseKey;
        this.plugin = plugin;
        this.validationServer = validationServer;
    }

    public Security setSecurityKey(String securityKey){
        this.securityKey = securityKey;
        return this;
    }

    public Security setConsoleLog(LogType logType){
        this.logType = logType;
        return this;
    }

    public Security debug(){
        debug = true;
        return this;
    }
