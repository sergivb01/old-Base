package net.veilmc.util.mkremins.fanciful;
...
import net.veilmc.util.net.amoebaman.util.ArrayWrapper;
...
import static net.veilmc.util.mkremins.fanciful.TextualComponent.rawText;
